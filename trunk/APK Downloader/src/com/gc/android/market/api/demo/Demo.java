package com.gc.android.market.api.demo;
...
public class Demo
{
    ...
    private static void testAsyncronousCalls(final String login, final String password, final String androidId,
        final String assetId, final String query)
    {
        try
        {
            ...
            CommentsRequest commentsRequest =
                CommentsRequest.newBuilder().setAppId(assetId).setStartIndex(0).setEntriesCount(10).build();

            //

            GetImageRequest imgReq =
            ...
            session.flush();
            session.append(commentsRequest, new MarketSession.Callback<CommentsResponse>()
            {

                @Override
                public void onResult(final ResponseContext context, final CommentsResponse response)
                {
                    System.out.println("Response : " + response);
                }
    ...
    private static void testSyncronousCalls(final String login, final String password, final String androidId,
    ...
    private static void testDownload(final String login, final String password, final String androidId,
        final String assetId)
    {
        try
        {
